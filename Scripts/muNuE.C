...
void muNuE(){
    ...
    TH1F h1("h1","Simulated Pion Energy from Muon Neutrino Interactions;TruePrimPartE;# of Muons", 40,0,4); //create a histogram for reconstructed track energies

    TH1F h2("h2","Truth-Matched Pion Energy from Muon Neutrino Interactions;TruePrimPartE;# of Muons", 40,0,4); //create a histogram for reconstructed track energies
...
//    h3->GetYaxis->SetTitle("Reconstruction Efficiency (%)");
    h3.SetTitle("Reconstruction Efficiency of Pions in Muon Neutrino Events by Energy");
    h3.Draw("EHIST");
